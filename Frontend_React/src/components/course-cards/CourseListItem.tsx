...
interface CourseListItemProps extends BoxProps {
  course: CourseVm;
  className?: string;
}

const _CourseListItem = forwardRef<HTMLDivElement, CourseListItemProps>(
...
const CourseListItem = createPolymorphicComponent<"div", CourseListItemProps>(_CourseListItem);
