        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<int>(type: "int", maxLength: 50, nullable: true),
                    Prerequisites = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    LearningOutcomes = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    ...
                    SectionCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    LectureCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_Media_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Media",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Courses_Media_PromoVideoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_Media_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Media",
                        principalColumn: "Id");
                    table.ForeignKey(
