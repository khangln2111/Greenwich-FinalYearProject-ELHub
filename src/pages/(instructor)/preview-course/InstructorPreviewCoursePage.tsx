...
import CourseDetailPageSkeleton from "../../(main)/course-detail/_c/CourseDetailPageSkeleton";
import CurriculumTab from "../../(main)/course-detail/_c/CurriculumTab/CurriculumTab";
import InstructorTab from "../../(main)/course-detail/_c/InstructorTab";
import OverviewTab from "../../(main)/course-detail/_c/OverviewTab";
import ReviewTab from "../../(main)/course-detail/_c/ReviewTab";
...
export default function InstructorPreviewCoursePage() {
  ...
  return (
    <div className="flex-1">
      ...
      >
        <Alert
          icon={<EyeIcon className="text-orange-500" size={20} />}
          title="You are viewing this course in Preview Mode"
          color="orange"
          variant="light"
          radius="lg"
        ...
        >
          <div className="flex flex-col gap-3 text-sm md:text-md">
            <p>
              Some features (like enrollment, reviews, or payments) may behave differently than in
