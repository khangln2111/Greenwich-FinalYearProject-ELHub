import { Button, Card, RingProgress, SimpleGrid, Title, Text, ScrollArea } from "@mantine/core";
import {
  DollarSignIcon,
  GiftIcon,
  LayersIcon,
...
export default function UserDashboardPage() {
  ...
  return (
    <>
      <PageSEO title="Personal Dashboard" />
      <div>
        {/* page header */}
        ...
        <SimpleGrid cols={{ base: 1, md: 2, xl: 3 }} spacing="md" mt="lg">
          <DashboardStatCard
            ...
            growth={stats.totalEnrolledCoursesGrowth}
          ...
          <DashboardStatCard
            title="Gifts Sent"
            value={stats.totalSentGifts}
            growth={stats.totalSentGiftsGrowth}
          ...
          <DashboardStatCard
            ...
            growth={stats.totalInventoryItemsGrowth}
          ...
          <DashboardStatCard
            title="Learning Time"
            value={stats.totalLearningSeconds}
            countUpProps={{
              formattingFn: (n) => (n / 3600).toFixed(1),
            }}
            suffix="h"
            growth={stats.totalLearningSecondsGrowth}
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg" mt="lg">
          ...
          >
            ...
            <FunnelChart
              ...
              data={[
                {
                  value: courseConversion.purchasedCoursesQuantity,
                  name: "Purchased (total qty)",
                  color: "violet.6",
                },
                {
                  value: courseConversion.purchasedCoursesUnique,
                  name: "Purchased (unique)",
                  color: "pink.6",
                },
                {
                  value: courseConversion.enrolledCourses,
                  name: "Enrolled",
                  color: "yellow.6",
                },
                {
                  value: courseConversion.completedCourses,
                  name: "Completed",
                  color: "teal.6",
                },
              ]}
          ...
          >
            ...
            <div className="self-center flex-1">
              <RingProgress
                ...
                thickness={18}
                sections={[
                  { value: overallCompletionPercent, color: "blue", tooltip: "Overall Completion" },
                ]}
                label={
