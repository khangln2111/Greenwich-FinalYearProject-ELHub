import { CompositeChart, DonutChart, RadarChart, BarChart } from "@mantine/charts";
import {
  SimpleGrid,
  Card,
  ScrollArea,
...
import { AdminDashboardVm } from "../../../../features/adminDashboard/adminDashboard.types";
import {
  BookOpenIcon,
  DollarSignIcon,
  LayersIcon,
...
type AdminDashboardInfoProps = {
  data: AdminDashboardVm;
};
    ...
    <>
      ...
      <SimpleGrid cols={{ base: 1, md: 2, xl: 3 }} spacing="md" mt="lg">
        ...
        <DashboardStatCard
          ...
          value={data.stats.pendingInstructorApplications}
          growth={data.stats.pendingInstructorApplicationsGrowth}
        ...
        <DashboardStatCard
          ...
          growth={data.stats.totalUsersGrowth}
        ...
        <DashboardStatCard
          ...
          growth={data.stats.totalInstructorsGrowth}
          icon={<UserCheckIcon size={20} />}
          classNames={{
        ...
        <DashboardStatCard
          ...
          value={data.stats.totalPendingCourses}
          growth={data.stats.totalPendingCoursesGrowth}
          icon={<BookOpenIcon size={20} />}
          classNames={{
        ...
        <DashboardStatCard
          ...
          value={data.stats.averageCourseRating}
          growth={data.stats.averageCourseRatingGrowth}
      ...
      <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg" mt="xl">
        ...
        >
          ...
          <div className="overflow-visible">
            <BarChart
              h={300}
              data={data.topInstructors.map((i) => ({
        ...
        >
          ...
          <div className="flex-1 self-center flex justify-center items-center">
            <SemiCircleProgress
              ...
              thickness={20}
              size={300}
              value={data.instructorVerification.percentageApproved}
              label={
                <span className="inline-block text-center leading-snug">
                  <span className="text-sm text-gray-500">
                    ({data.instructorVerification.approved}/
                    {data.instructorVerification.pending + data.instructorVerification.approved})
                  </span>
                  <br />
                  <span className="font-semibold">
                    {data.instructorVerification.percentageApproved}% Approved
                  </span>
                </span>
              }
            />
        ...
        >
          ...
          <div className="flex-1 self-center flex justify-center items-center">
            <SemiCircleProgress
              ...
              thickness={20}
              size={300}
              value={data.courseVerification.percentageApproved}
              label={
                <span className="inline-block text-center leading-snug">
                  <span className="text-sm text-gray-500">
                    ({data.courseVerification.approved}/
                    {data.courseVerification.pending + data.courseVerification.approved})
                  </span>
                  <br />
                  <span className="font-semibold">
                    {data.courseVerification.percentageApproved}% Approved
                  </span>
                </span>
              }
            />
