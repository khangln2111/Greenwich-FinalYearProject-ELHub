...
const _CourseCardVer2 = forwardRef<HTMLDivElement, CourseCardProps>(
          ...
          <div className="flex flex-col flex-grow space-y-2">
            ...
            <Tooltip label={course.title} withArrow position="bottom">
              <Text
                ...
                className="text-xl font-semibold leading-snug line-clamp-2 hover:text-blue-600 dark:hover:text-blue-400
                  transition"
              >
                {course.title}
              </Text>
...
const CourseCardVer2 = createPolymorphicComponent<"div", CourseCardProps>(_CourseCardVer2);
