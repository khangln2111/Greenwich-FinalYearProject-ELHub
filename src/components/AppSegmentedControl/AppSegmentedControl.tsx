...
import classes from "./AppSegmentedControl.module.css";

export type AppSegmentedControlStylesNames =
  | "root"
  | "input"
  | "label"
  | "control"
  | "indicator"
  | "innerLabel";
export type AppSegmentedControlCssVariables = {
  root:
    | "--sc-radius"
    | "--sc-color"
    | "--sc-font-size"
...
export interface AppSegmentedControlItem {
  value: string;
...
export interface AppSegmentedControlProps
  extends BoxProps,
    StylesApiProps<AppSegmentedControlFactory>,
    ElementProps<"div", "onChange"> {
  /** Data based on which controls are rendered */
  data: (string | AppSegmentedControlItem)[];
...
export type AppSegmentedControlFactory = Factory<{
  props: AppSegmentedControlProps;
  ref: HTMLDivElement;
  stylesNames: AppSegmentedControlStylesNames;
  vars: AppSegmentedControlCssVariables;
}>;

const defaultProps = {
  withItemsBorders: true,
} satisfies Partial<AppSegmentedControlProps>;

const varsResolver = createVarsResolver<AppSegmentedControlFactory>(
...
export const AppSegmentedControl = factory<AppSegmentedControlFactory>((_props, ref) => {
  const props = useProps("AppSegmentedControl", defaultProps, _props);
  const {
    classNames,
    className,
    style,
  ...
  const getStyles = useStyles<AppSegmentedControlFactory>({
...
AppSegmentedControl.classes = classes;
AppSegmentedControl.displayName = "@mantine/core/AppSegmentedControl";
