...
public static class AppConstants
{
    ...
    public static class InstructorApplication
    {
        ...
        public const int MaxRetryCount = 2; // Maximum retry attempts for application review
    ...
    public static class Course
    {
        ...
        public const int ImageMaxSizeBytes = 50 * FileSize.Megabyte;
        public const int MaxRetryCount = 2; // Maximum retry attempts for course approval
        public const int RetryCooldownDays = 0; // Maximum days after which the last rejection is considered invalid
    }
